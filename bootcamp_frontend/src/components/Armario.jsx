...
function Armario() {
    const [selectedClothing, setSelectedClothing] = useState([{ tipo: 'cap2', scale: 0.016, position: [0, 1, 0], url: './model2.glb', color: '' }/* { tipo: 'cap2', scale: 20, position: [0, 0, 0], url: './model.glb', color: '' } */]);
